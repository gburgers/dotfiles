	...
	},
	{
		...
		config = function()
			...
			local servers = {
				-- clangd = {},
				gopls = {
					filetypes = { "go", "gomod", "gowork", "gotmpl" }, -- explicitly exclude "templ"
					settings = {
						gopls = {
			...
			vim.list_extend(ensure_installed, {
				...
				"goimports",
				-- "markdownlint",
				"json-lsp", -- De LSP (jsonls)
				"prettier", -- De formatter
				"prettierd", -- De formatter
				"jq", -- De krachtige JSON processor
				"jsonlint", -- De linter
			})
			...
			require("mason-lspconfig").setup({
				...
				handlers = {
					function(server_name)
						...
						-- EXPLICIT FILETYPE HANDLING
						if server_name == "gopls" then
							server.filetypes = { "go", "gomod", "gowork" } -- NO gotmpl
						elseif server_name == "templ" then
							server.filetypes = { "templ" } -- ONLY templ
						end
